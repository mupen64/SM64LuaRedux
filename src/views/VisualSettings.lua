...
-- items are generated dynamically in draw() so that labels reflect the
-- current locale when users switch languages at runtime.
...
return {
    ...
    draw = function()
        Drawing.setting_list(make_items(), { x = 0, y = 0.1 })
    end,
}
