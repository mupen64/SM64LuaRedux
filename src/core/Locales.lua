...
---@field public SEMANTIC_WORKFLOW_INPUTLIST_SECTION string
---@field public SEMANTIC_WORKFLOW_INPUTLIST_STICK string
---@field public SEMANTIC_WORKFLOW_INPUTLIST_UNTIL string
