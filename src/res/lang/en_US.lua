return {
    ...
    PIANO_ROLL_HELP_SHOW_TOOL_TIP = "Show Help",
    PIANO_ROLL_HELP_EXIT_TOOL_TIP = "Exit",
    ...
    PIANO_ROLL_PROJECT_NEW_TOOL_TIP = "Create a new project in a new location",
    PIANO_ROLL_PROJECT_OPEN = "Open",
    PIANO_ROLL_PROJECT_OPEN_TOOL_TIP = "Open an existing project",
    PIANO_ROLL_PROJECT_SAVE = "Save",
    PIANO_ROLL_PROJECT_SAVE_TOOL_TIP = "Save the current project (no confirmation!)",
    PIANO_ROLL_PROJECT_PURGE = "Purge",
    PIANO_ROLL_PROJECT_PURGE_TOOL_TIP = "Remove files that do not belong to this project",
    PIANO_ROLL_PROJECT_DISABLE = "Disable",
    PIANO_ROLL_PROJECT_DISABLE_TOOL_TIP = "Do not override inputs with any sheet",
    PIANO_ROLL_PROJECT_ADD_SHEET = "Add Sheet...",
    PIANO_ROLL_PROJECT_REBASE_SHEET_TOOL_TIP = "Set start to now",
    PIANO_ROLL_PROJECT_REPLACE_INPUTS_TOOL_TIP = "Replace inputs",
    PIANO_ROLL_PROJECT_PLAY_WITHOUT_ST_TOOL_TIP = "Play without loading .st",
    PIANO_ROLL_PROJECT_DELETE_SHEET_TOOL_TIP = "Delete",
    PIANO_ROLL_PROJECT_ADD_SHEET_TOOL_TIP = "Add",
    PIANO_ROLL_PROJECT_MOVE_SHEET_UP_TOOL_TIP = "Move up",
    PIANO_ROLL_PROJECT_MOVE_SHEET_DOWN_TOOL_TIP = "Move down",
    PIANO_ROLL_INPUTS_EXPAND_SECTION = "Expand",
    PIANO_ROLL_INPUTS_COLLAPSE_SECTION = "Collapse",
    PIANO_ROLL_INPUTS_INSERT_SECTION = "+Section",
    PIANO_ROLL_INPUTS_INSERT_SECTION_TOOL_TIP = "Insert section after selected",
    PIANO_ROLL_INPUTS_DELETE_SECTION = "-Section",
    PIANO_ROLL_INPUTS_DELETE_SECTION_TOOL_TIP = "Delete selected section",
    PIANO_ROLL_INPUTS_TIMEOUT = "Timeout:",
    PIANO_ROLL_INPUTS_TIMEOUT_TOOL_TIP = "End section after at most N frames",
    PIANO_ROLL_INPUTS_END_ACTION = "End action:",
    PIANO_ROLL_INPUTS_END_ACTION_TOOL_TIP = "End section when Mario enters this action",
    PIANO_ROLL_INPUTS_END_ACTION_TYPE_TO_SEARCH_TOOL_TIP = "Type to filter actions",
    PIANO_ROLL_INPUTS_INSERT_INPUT = "+Input",
    PIANO_ROLL_INPUTS_INSERT_INPUT_TOOL_TIP = "Insert frame after selected",
    PIANO_ROLL_INPUTS_DELETE_INPUT = "-Input",
    PIANO_ROLL_INPUTS_DELETE_INPUT_TOOL_TIP = "Delete selected frame",
    -- Settings Tab
